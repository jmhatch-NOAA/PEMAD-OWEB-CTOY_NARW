...
For all metrics, the blue bar indicates when the monthly metric exceeded the respective average annual regional density. The y-axis of the Gantt charts indicates the degree that active lease areas were buffered (0km = not buffered, 10km = buffered by 10km, and 40km = buffered by 40km).
