...
For all metrics, the blue bar indicates when the monthly value exceeded the average annual density for the respective region. The y-axis of the Gantt charts indicates the degree that active lease areas were buffered (0km = not buffered, 10km = buffered by 10km, and 40km = buffered by 40km).
