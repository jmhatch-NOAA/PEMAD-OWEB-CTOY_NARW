...
3) 50th percentile
4) Average
For all metrics, the blue bar indicates when the monthly value exceeded the annual, regional value. The y-axis of the Gantt charts indicates the degree that active lease WEAs were buffered (0km = not buffered, 10km = buffered by 10km, and 40km = buffered by 40km).
