...
Now a quick look at the distribution of seasonal NARW densities by active lease WEAs (roughly ordered from north to south). The upper whisker of the boxplots denote the 90th percentile, with the dashed line representing a density trigger of 1 whale / 100km2 (approximately the visual trigger for a DMA).
